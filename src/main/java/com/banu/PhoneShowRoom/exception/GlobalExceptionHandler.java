...
import static com.banu.PhoneShowRoom.exception.ErrorType.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PhoneShowRoomException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleMonolitSpotifyException(PhoneShowRoomException exception){
